...
/* Vendor XCV functions */
DEF_HELPER_FLAGS_3(cv_bitrev, TCG_CALL_NO_RWG_SE, tl, tl, tl, tl)
DEF_HELPER_FLAGS_3(cv_extract, TCG_CALL_NO_RWG_SE, tl, tl, tl, tl)
DEF_HELPER_FLAGS_3(cv_extractu, TCG_CALL_NO_RWG_SE, tl, tl, tl, tl)
DEF_HELPER_FLAGS_2(cv_extractr, TCG_CALL_NO_RWG_SE, tl, tl, tl)
DEF_HELPER_FLAGS_2(cv_extractur, TCG_CALL_NO_RWG_SE, tl, tl, tl)
DEF_HELPER_FLAGS_3(cv_insert, TCG_CALL_NO_RWG_SE, tl, tl, tl, tl)
DEF_HELPER_FLAGS_2(cv_insertr, TCG_CALL_NO_RWG_SE, tl, tl, tl)
DEF_HELPER_FLAGS_3(cv_bclr, TCG_CALL_NO_RWG_SE, tl, tl, tl, tl)
DEF_HELPER_FLAGS_2(cv_bclrr, TCG_CALL_NO_RWG_SE, tl, tl, tl)
DEF_HELPER_FLAGS_3(cv_bset, TCG_CALL_NO_RWG_SE, tl, tl, tl, tl)
DEF_HELPER_FLAGS_2(cv_bsetr, TCG_CALL_NO_RWG_SE, tl, tl, tl)
DEF_HELPER_FLAGS_1(cv_ff1, TCG_CALL_NO_RWG_SE, tl, tl)
DEF_HELPER_FLAGS_1(cv_fl1, TCG_CALL_NO_RWG_SE, tl, tl)
DEF_HELPER_FLAGS_1(cv_clb, TCG_CALL_NO_RWG_SE, tl, tl)
DEF_HELPER_FLAGS_1(cv_cnt, TCG_CALL_NO_RWG_SE, tl, tl)
DEF_HELPER_FLAGS_2(cv_ror, TCG_CALL_NO_RWG_SE, tl, tl, tl)
